...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define SAMPLING_FREQ 48000.0		//BSP_audio_out sampling frequency
...
#define NUM_TAPS		29			//Filtro eile
	//--- FIR related PD END ---
...
/* USER CODE BEGIN PV */
static int16_t OutputBuffer[TEST_LENGTH_SAMPLES*2];			//Output Buffer, left+right channels
