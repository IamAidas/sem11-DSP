...
Drivers/CMSIS/DSP/Source/TransformFunctions/%.o: ../Drivers/CMSIS/DSP/Source/TransformFunctions/%.S Drivers/CMSIS/DSP/Source/TransformFunctions/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"C:/workspace/sem11-DSP/Labs/3-LB/STM32F4_DSP_3_IIR_20231013/STM32F4_DSP_3_IIR/Drivers/CMSIS/DSP/Include" -I"C:/workspace/sem11-DSP/Labs/3-LB/STM32F4_DSP_3_IIR_20231013/STM32F4_DSP_3_IIR/Drivers/BSP/STM32F4-Discovery" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
