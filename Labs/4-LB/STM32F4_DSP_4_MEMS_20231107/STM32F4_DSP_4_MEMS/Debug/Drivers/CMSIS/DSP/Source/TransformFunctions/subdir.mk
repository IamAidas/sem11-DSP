...
Drivers/CMSIS/DSP/Source/TransformFunctions/%.o: ../Drivers/CMSIS/DSP/Source/TransformFunctions/%.S Drivers/CMSIS/DSP/Source/TransformFunctions/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"C:/workspace/sem11-DSP/Labs/4-LB/STM32F4_DSP_4_MEMS_20231107/STM32F4_DSP_4_MEMS/Drivers/CMSIS/DSP/Include" -I"C:/workspace/sem11-DSP/Labs/4-LB/STM32F4_DSP_4_MEMS_20231107/STM32F4_DSP_4_MEMS/Drivers/BSP/STM32F4-Discovery" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
