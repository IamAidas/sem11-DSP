...
/* USER CODE BEGIN PV */
	...
	//*** BSP Audio IN ***//
	static uint16_t InternalBuffer[INTERNAL_BUFF_SIZE];		//PDM samples. Size defined stm32f4_discovery_audio.h
	static uint16_t RecBuf[PCM_OUT_SIZE*2];					//PCM stereo samples. Size defined  stm32f4_discovery_audio.h
